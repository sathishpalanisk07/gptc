...
`.trim();
  ...
  return (
    <>
      ...
      <header className={`header ${scrolled ? "sticky-top" : "position_absolute"}`}>
        <div className="container">
          <nav>
                  ...
                  <li >
                    ...
                    <Dropdown className="serviceDropdown">
                      ...
                      <Dropdown.Menu>
                        ...
                        <Dropdown.Item href="/service-page/online_safety_testing">CSP (Concentrates solar Power) Parabolic Solar Panels maintenance</Dropdown.Item>
                        <Dropdown.Item href="/service-page/online_safety_testing">CSP HTF tube welding</Dropdown.Item>
                        <Dropdown.Item href="/service-page/online_safety_testing">Piping and fabrication work</Dropdown.Item>
                        <Dropdown.Item href="/service-page/online_safety_testing">Electrical Transformer, Switchgear, Cable, Relay testing</Dropdown.Item>
                        <Dropdown.Item href="/service-page/online_safety_testing">SWRO, BWRO Membrane replacement</Dropdown.Item>
                        <Dropdown.Item href="/service-page/online_safety_testing">SUPPLY OF ENGINEER TO leading consultant (ENERGO, INTEC GOPA, EDF, MITSUBISHI ELECTRIC)</Dropdown.Item>
                        <Dropdown.Item href="/service-page/online_safety_testing">PIPELINE PIGGING WORK (PIPE CLEANING WORK)</Dropdown.Item>
