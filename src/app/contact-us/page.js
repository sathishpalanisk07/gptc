...
const Page = () => {
    return (
        <>
        <InnerBanner className="mb_80" title="Contact Us" image="/assets/img/company-photo/sl3.jpg"/>
                    ...
                    <div className='row'>
                        <div className='col-lg-6'>
                            <div className="site-heading">
                                ...
                                <p className='fontSize16 fontWeight400 shearwaterBlackText_clr'>Let us know how we can help you with your existing or future projects, and one of our sales or support representatives will contact you shortly.</p>
                            </div>
                        </div>
                    </div>
